...
//What Does TRoundedContainer Do?
//backgroundColor: Sets the background color of the container.
//borderRadius: Defines how rounded the corners of the container should be. This would typically be set to a default value, but you can customize it.
//padding: Adds padding inside the container, around the child widget(s).
//margin: Adds margin around the container, creating space outside of it.
//borderColor: Optionally adds a border around the container with a specified color.